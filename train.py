...
Examples:
  ...
  python train.py --list-models
    ...
    parser.add_argument('--hsv-h', type=float, default=0.01, help='HSV hue augmentation (default: 0.01)')
    parser.add_argument('--hsv-s', type=float, default=0.01, help='HSV saturation augmentation (default: 0.01)')
    parser.add_argument('--hsv-v', type=float, default=0.01, help='HSV value augmentation (default: 0.01)')
    parser.add_argument('--degrees', type=float, default=2.0, help='Random rotation degrees (default: 2.0)')
    parser.add_argument('--translate', type=float, default=0.1, help='Random translate ratio (default: 0.1)')
    parser.add_argument('--scale', type=float, default=0.2, help='Random scale range (default: 0.2)')
    parser.add_argument('--shear', type=float, default=0.0, help='Random shear degrees (default: 0.0)')
